...
public class MahasiswaDemo26 {
    ...
    do {
        ...
        System.out.println("6. Melihat Jumlah Tugas yang sudah terkumpul");
        ...
        switch (pilih) {
            ...
            case 3:
                ...
                break;
            case 4:
                Mahasiswa26 lihatBawah = stack.peekBottom();
                if (lihatBawah != null) {
            ...
            case 5:
                ...
                break;
            case 6:
                System.out.println("Jumlah tugas yang sudah terkumpul saat ini adalah : " + stack.jmlTugas());
                break;
                default:
